...
class BatterScoreTeamOne extends StatefulWidget {
  const BatterScoreTeamOne({super.key});

  @override
  State<BatterScoreTeamOne> createState() => _BatterScoreTeamOneState();
}

class _BatterScoreTeamOneState extends State<BatterScoreTeamOne> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child:
        ...
        return Column(
          children: [
            if (state.scoreCard.data?.scoreCard?[1].batTeamDetails
                    ?.batsmenData !=
                null)
              Padding(
                          ...
                          children: [
                            playerRow(
                              ...
                              runs: state.scoreCard.data?.scoreCard?[1]
                                      ...
                                      .toString() ??
                                  '',
                              balls: state.scoreCard.data?.scoreCard?[1]
                                      .batTeamDetails?.batsmenData?.bat1?.balls
                                      .toString() ??
                                  '',
                              fours: state.scoreCard.data?.scoreCard?[1]
                                      .batTeamDetails?.batsmenData?.bat1?.fours
                                      .toString() ??
                                  '',
                              sixers: state.scoreCard.data?.scoreCard?[1]
