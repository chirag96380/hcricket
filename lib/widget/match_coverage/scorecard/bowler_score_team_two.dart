...
class BowlerScoreTeamTwo extends StatefulWidget {
  const BowlerScoreTeamTwo({super.key});

  @override
  State<BowlerScoreTeamTwo> createState() => _BowlerScoreTeamTwoState();
}

class _BowlerScoreTeamTwoState extends State<BowlerScoreTeamTwo> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child:
        ...
        return Column(
          children: [
            if (state.scoreCard.data?.scoreCard?[0].bowlTeamDetails
                    ?.bowlersData !=
                null)
              Padding(
                    ...
                    if (state.scoreCard.data?.scoreCard?[0].bowlTeamDetails
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            if (state.scoreCard.data?.scoreCard?[0]
